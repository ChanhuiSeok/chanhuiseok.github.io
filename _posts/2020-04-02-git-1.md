---
title: "[GitHub] GitHub Action을 사용하여 자동 크롤링과 Push 구현하기"
...
# GitHub Action을 사용하여 자동 크롤링과 Push 구현하기
...
* build 밑에는 실제로 실행할 부분들을 설정하는 곳입니다. 주요 내용을 살펴 보자면,
  ...
  * Commit 단계에서는 크롤러 파일을 돌려서 변화가 생긴 json 파일을 push하기 위한 git 명령어들을 작성합니다. 커밋 메세지 등 자신에 맞도록 자유롭게 설정합니다.
...
Action 기능으로 자동 크롤링과 푸시를 구현하였는데, 실시간 뉴스같이 계속 변하는 데이터들을 크롤링하여 서비스를 하는 등 많은 부분에서 유용하게 활용할 수 있을 것으로 생각됩니다.